...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Mirai Team",
  description: "Gọi bot và phản hồi lại",
...
module.exports.handleEvent = function({ api, event }) {
  ...
  var tl = ["Chào bạn, tôi là bot của Khanh Shado","Bạn có biết tôi yêu bạn vai lon","M ko bt là t là đại ca tịnh thất bồng lai à hoho","Vợ gọi có việc gì không?","Sử dụng callad để liên lạc với admin!","Em là bot cute nhất hành tinh","Chúa phù hộ em","Em đây~~~~","Yêu anh Duy nhất","Đi giải cứu Diễm Mi nàooo","Gọi tao lm gì sủa lẹ","Sao thế công chúa","mô phật", "Tuyển phi công ạ","Làm bồ em ko ạ? dui lắm","Cậu cô đơn ko?","Tuyển ghệ đít bự đi bay lắc","Được của ló :)))", "Mong thí chủ đừng spam có đc hog hả","Đừng khen em ngại quá hí hí","Làm chồng em ko ạ?","Đừng spam em nha :<<","Bằng lái hủ tiếu kinh nghiệm đầy minh tuyển ghệ đít bự","Tịnh tâm","Omg yêu mọi người <3","Mik đang ế ai hốt yêu lun 😼","Chồng em đây rồi","Nứng à kiu hoài","Mik Hog Tồi Nhoaaa","ăn cuk hog mà kiu","hỏ ai kiu bot dọ"];
  ...
  if ((event.body.toLowerCase() == "bot chó") || (event.body.toLowerCase() == "như chó")) {
    return api.sendMessage("Chó nào vừa nói xấu tao đấy, muốn chết hả😠", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "ơi") || (event.body.toLowerCase() == "ơi")) {
    return api.sendMessage("Ơi :)? Ơi gì tương tác hộ con cái :>>>", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "yêu") || (event.body.toLowerCase() == "yeu")) {
    return api.sendMessage("Cóm tró cc, yêu đương cailon tiền, xe, nhà thì đéo có mà yêu với đương, lo học hành và đi làm kiếm tiền đê yêu sau", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "Khanh") || (event.body.toLowerCase() == "khanh" {
    return api.sendMessage("Gọi chủ tao làm gì?", threadID);
  };


  if ((event.body.toLowerCase() == "Bot hay") || (event.body.toLowerCase() == "bot hay" {
    return api.sendMessage("Iu bé nhất❤️", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "Anh Duy") || (event.body.toLowerCase() == "anh suy")) {
  ...
  if ((event.body.toLowerCase() == "a Duy") || (event.body.toLowerCase() == "a duy")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };

  if ((event.body.toLowerCase() == "Duy") || (event.body.toLowerCase() == "duy")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };

  if ((event.body.toLowerCase() == "@Phan Duy") || (event.body.toLowerCase() == "@Phan Duy")) {
    return api.sendMessage("Ai kêu chủ tao đấy, mà làm ơn đừng tag anh ấy mà hãy liên hệ qua Fb: https://www.facebook.com/duybraves", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mn") || (event.body.toLowerCase() == "bsvv nha mn")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao Phan Duy có gì dùng lệnh ad hoặc adm để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "ông phúc") || (event.body.toLowerCase() == "ong phuc")) {
    return api.sendMessage("️Kêu chủ của tôi gì á :)?", threadID);
  };

  if ((event.body.toLowerCase() == "ôg phúc") || (event.body.toLowerCase() == "og phuc")) {
